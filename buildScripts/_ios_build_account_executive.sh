#!/bin/bash
#NOTE: INSIGHTS_API_KEY_* and SI_SIGN_KEY are set up in the 'Account Executive App - iOS App Jenkins' Configuration
...
function CreateBuild {
	find ./source -name 'Info.plist' -not -path '*/bin/*' -not -path '*/obj/*' | while read plist; do
