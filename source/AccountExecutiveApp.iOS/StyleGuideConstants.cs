...
namespace AccountExecutiveApp.iOS
{
    public static class StyleGuideConstants
    {
        ...
        public static readonly UIColor RedUiColor = new UIColor(0.96875f, 0.2265625f, 0.24609375f, 1); //#f83a3f RGB: 248 58 63
        ...
        public static readonly UIColor LighterGrayUiColor = UIColor.FromWhiteAlpha (0.95f, 1.0f);
