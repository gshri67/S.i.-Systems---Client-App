...
VALUES
(
	1, 1, 459, 172, 7, 10, 1, 1, 575, '2013-12-11', '2014-1-1'
),
(
	2, 2, 459, 172, 7, 10, 1, 1, 575, '2012-12-11', '2013-12-10'
),
(
	3, 3, 459, 172, 7, 11, 2, 2, 575, '2012-12-11', '2013-12-10'
),
(
	4, 4, 459, 172, 7, 12, 1, 1, 575, '2012-12-11', '2016-12-10'
),
(
	5, 5, 459, 172, 7, 12, 3, 3, 573, '2013-12-11', '2050-12-10'
),
(
	6, 6, 459, 172, 7, 13, 4, 3, 573, '2012-12-11', '2016-12-10'
),
--Expired Jobs
(
	7, 7, 458, 172, 7, NULL, 1, 1, 575, '2013-12-11', '2016-01-01'
),
--Cancelled Jobs
(
	8, 8, 458, 171, 7, NULL, 1, 1, 574, '2012-12-11', '2016-01-01'
),
--Active Jobs
(
	9, 9, 458, 171, 7, NULL, 2, 2, 580, '2016-01-01', '2017-06-15'
),
(
	10, 10, 458, 172, 7, NULL, 1, 1, 580, '2016-01-01', '2016-02-15'
),
(
	11, 11, 458, 172, 7, NULL, 3, 3, 580, '2016-01-01', '2050-12-10'
),
(
	12, 12, 458, 172, 7, NULL, 4, 3, 580, '2016-01-01', '2016-12-31'
);
